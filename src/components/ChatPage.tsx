...
const initialConversations = {
  '1': [
    { id: '1', sender: 'Maxim Qu', text: 'Hey! How are you doing with the cps homework?', time: '10:30 AM', isMe: false },
    { id: '2', sender: 'Me', text: "I'm working through Q2a right now. It's pretty challenging!", time: '10:32 AM', isMe: true },
    { id: '3', sender: 'Maxim Qu', text: "Same bruh, want to meet up later today to work on it together?", time: '10:33 AM', isMe: false },
    { id: '4', sender: 'Me', text: "Ouiiii, I'm free after 3pm. Redpath 2nd floor?", time: '10:35 AM', isMe: true },
    { id: '5', sender: 'Maxim Qu', text: "Sick, see you there at 3:30pm?", time: '10:36 AM', isMe: false },
          ...
          {mockChats.map((chat) => (
            <button
              ...
              className={`w-full p-4 flex items-center gap-3 hover:bg-gray-50 transition-colors border-b border-gray-100 ${
                selectedChat.id === chat.id ? 'bg-gradient-to-r from-[#757bc8]/10 to-[#9fa0ff]/10' : ''
              }`}
            >
          ...
          {currentMessages.map((msg) => (
            <div key={msg.id} className={`flex ${msg.isMe ? 'justify-end' : 'justify-start'}`}>
              <div className="max-w-md">
                ...
                <p className={`text-xs text-gray-400 mt-1 ${msg.isMe ? 'text-right mr-1' : 'ml-3'}`}>
                  {msg.time}
                </p>
              </div>
            </div>
